...
export const HomeHeroSection = () => {
  return (
    <section>
      <div className="container flex flex-col items-center lg:flex-row lg:justify-between lg:h-[585px] lg:mt-[86px]">
        <div className="lg:flex lg:flex-col lg:justify-center lg:w-[740px]">
          <h1 className="font-sans text-4xl w-[320px] lg:w-[700px] lg:text-6xl lg:leading-[79px] font-bold">
          ...
          <div className="flex lg:flex-row flex-col items-center justify-center mt-10 gap-4 lg:items-start lg:justify-start">
            <Button className="w-full lg:w-[210px] lg:text-sm">
              Download App
            </Button>
            <Button className="w-full bg-gray-dark lg:w-[210px] lg:text-sm">
              view pricing
            </Button>
          </div>
        </div>
